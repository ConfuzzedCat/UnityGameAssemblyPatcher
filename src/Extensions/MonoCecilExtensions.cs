...
namespace UnityGameAssemblyPatcher.Extensions
{
    ...
    {
        public static bool EqualsCallOperand(this Instruction self, Instruction other)
        {
            var selfOperand = self.Operand as MemberReference;
            var otherOperand = other.Operand as MemberReference;

            return selfOperand!.FullName.Equals(otherOperand!.FullName);
        }
